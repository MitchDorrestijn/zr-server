...
public class RideEntity {
    ...
    @Column(name = "preferedCareInstitution")
    int preferedCareInstitution;

    @Column(name = "preferedDriver")
    int preferedDriver;
     ...
     */
    public Date getDropOffLocation() {
     ...
     */
    public void setDropOffLocation(Date dropOffLocation) {
